...
export const AudioPlayer: React.FC<AudioPlayerProps> = ({
  ...
  return (
    <div className={`flex items-center gap-3 ${className}`}>
      ...
      <button
        onClick={togglePlay}
        className="transition-colors cursor-pointer text-text hover:text-brand"
      ...
      <div className="flex-1 flex items-center gap-2">
        ...
        <input
          ...
          className={`flex-1 h-1 rounded-lg appearance-none cursor-pointer focus:outline-none focus:ring-1 focus:ring-brand ${progressPercent >= 99.5 ? "[&::-webkit-slider-thumb]:translate-x-0.5 [&::-moz-range-thumb]:translate-x-0.5" : ""}`}
          style={{
