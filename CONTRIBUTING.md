...
Thank you for your interest in contributing to Echo! This guide will help you get started with contributing to this open source speech-to-text application.

## 📖 Philosophy

Echo aims to be the most forkable speech-to-text app. The goal is to create both a useful tool and a foundation for others to build upon—a well-patterned, simple codebase that serves the community. We prioritize:
...
2. **Clone your fork**:
   ```bash
   git clone git@github.com:YOUR_USERNAME/Echo.git
   cd Echo
   ```

3. **Add upstream remote**:
   ```bash
   git remote add upstream git@github.com:damien-schneider/Echo.git
   ```
...
Echo follows a clean architecture pattern:
...
1. **Search existing issues** at [github.com/damien-schneider/Echo/issues](https://github.com/damien-schneider/Echo/issues)
2. **Check discussions** at [github.com/damien-schneider/Echo/discussions](https://github.com/damien-schneider/Echo/discussions)
...
1. **Search existing discussions** at [github.com/damien-schneider/Echo/discussions](https://github.com/damien-schneider/Echo/discussions)

### Submitting a Feature Request

1. Go to [Discussions](https://github.com/damien-schneider/Echo/discussions)
...
4. Describe your feature idea including:
   ...
   - How it fits with Echo's philosophy
...
7. **Create a Pull Request**:
   - Go to the [Echo repository](https://github.com/damien-schneider/Echo)
...
- **Discussions**: Ask questions in [GitHub Discussions](https://github.com/damien-schneider/Echo/discussions)
- **Email**: Reach out at [contact@handy.computer](mailto:contact@handy.computer)

## 📜 License

By contributing to Echo, you agree that your contributions will be licensed under the MIT License. See [LICENSE](LICENSE) for details.

---

**Thank you for contributing to Echo!** Your efforts help make speech-to-text technology more accessible, private, and extensible for everyone.
